...
<head>
  ...
  <title>Validación de acceso &mdash; Plataforma OIRS</title>
      ...
      <div class="container mt-5">
        <div class="page-error">
          <div class="page-inner">
			...
			<p>
				Lo sentimos, el acceso a esta página ha sido restringida o ha expirado.			
			</p>
			<p>
				Solicite su acceso nuevamente en formulario "Olvidé mi contraseña" o Contacte al administrador del sito.			
			</p>
            </div>
            <div class="mt-5">
