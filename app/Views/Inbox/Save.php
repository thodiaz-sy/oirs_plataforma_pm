	...
	<div class="card-body pb-0">
		<?php if(!isset($invoice) || (isset($invoice) && isset($form))){
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="paciente-tab" data-toggle="tab" href="#gesPaciente" role="tab" aria-controls="management" aria-selected="false">Gestión</a>
				</li>
				<?php } ?>
				<li class="nav-item">
			...
			<div class="tab-content" id="myTabContent">
				...
				<div id="accordion">
					<div class="card no-box-shadow mb-0">
						...
						<button type="button" class="btn btn-link" data-toggle="collapse" data-target="#colapsablePaciente" aria-expanded="true" aria-controls="colapsablePaciente">
						<h4>Identificación del Paciente</h4>
						</button>
						</div>
						<div id="colapsablePaciente" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
						<div class="card-body pb-0">
						<div class="row">
						...
						<div class="card no-box-shadow mb-0">
							...
							<h5 class="mb-0">
								<button type="button" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThird" aria-expanded="false" aria-controls="collapseThird">
			...
			<div class="tab-pane fade tab-parent-save" id="gesPaciente" role="tabpanel" aria-labelledby="paciente-tab">
				<div id="accordion">					
					<div class="card no-box-shadow mb-0">
						<div class="card-header" id="headingOne">
							<h5 class="mb-0">
								<button type="button" class="btn btn-link" data-toggle="collapse" data-target="#colapsableGinterna" aria-expanded="true" aria-controls="colapsableGinterna">
								<h4>Gestión Interna</h4>
								</button>
							</h5>
						</div>

						<div id="colapsableGinterna" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
					...
					<div class="row">
						<div class="card no-box-shadow col-md-6">
							<div class="card-header" id="headingTwo">
								<h5 class="mb-0">
									<button type="button" class="btn btn-link collapsed" data-toggle="collapse" data-target="#colapsableGestion" aria-expanded="false" aria-controls="colapsableGestion">
									<h4>Gestión del Paciente</h4>
									</button>
								</h5>
							</div>
							<div id="colapsableGestion" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
								<div class="card-body">
									<div class="alert alert-info" role="alert">
							...
							<div id="colapsableGestion" class="col-md-6 collapse" aria-labelledby="headingTwo" data-parent="#accordion">
								<div class="card no-box-shadow col-md-12">
									<div class="card-body">
